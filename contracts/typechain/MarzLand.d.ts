...
interface MarzLandInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'lootDAO', values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: 'lootDAO', data: BytesLike): Result
...
export class MarzLand extends BaseContract {
  ...
  functions: {
    ...
    lootDAO(overrides?: CallOverrides): Promise<[string]>
  ...
  estimateGas: {
    ...
    lootDAO(overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    lootDAO(overrides?: CallOverrides): Promise<PopulatedTransaction>
